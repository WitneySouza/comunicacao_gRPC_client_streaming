...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<br.edu.ifg.proto.calculator.SumRequest,
      br.edu.ifg.proto.calculator.SumResponse> getSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Sum",
      requestType = br.edu.ifg.proto.calculator.SumRequest.class,
      responseType = br.edu.ifg.proto.calculator.SumResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<br.edu.ifg.proto.calculator.SumRequest,
      br.edu.ifg.proto.calculator.SumResponse> getSumMethod() {
    io.grpc.MethodDescriptor<br.edu.ifg.proto.calculator.SumRequest, br.edu.ifg.proto.calculator.SumResponse> getSumMethod;
    if ((getSumMethod = CalculatorServiceGrpc.getSumMethod) == null) {
      synchronized (CalculatorServiceGrpc.class) {
        if ((getSumMethod = CalculatorServiceGrpc.getSumMethod) == null) {
          CalculatorServiceGrpc.getSumMethod = getSumMethod =
              io.grpc.MethodDescriptor.<br.edu.ifg.proto.calculator.SumRequest, br.edu.ifg.proto.calculator.SumResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Sum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.edu.ifg.proto.calculator.SumRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.edu.ifg.proto.calculator.SumResponse.getDefaultInstance()))
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sum(br.edu.ifg.proto.calculator.SumRequest request,
  ...
  public static final class CalculatorServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<CalculatorServiceBlockingStub> {
    ...
    /**
     */
    public br.edu.ifg.proto.calculator.SumResponse sum(br.edu.ifg.proto.calculator.SumRequest request) {
  ...
  public static final class CalculatorServiceFutureStub extends io.grpc.stub.AbstractFutureStub<CalculatorServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<br.edu.ifg.proto.calculator.SumResponse> sum(
        br.edu.ifg.proto.calculator.SumRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUM:
          serviceImpl.sum((br.edu.ifg.proto.calculator.SumRequest) request,
              (io.grpc.stub.StreamObserver<br.edu.ifg.proto.calculator.SumResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class CalculatorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.edu.ifg.proto.calculator.Calculator.getDescriptor();
    }
